        ...
        <form class="form" action="" method="post" >
            ...
            <fieldset>
                ...
                <button role="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="button" type="submit">
                    <span class="ui-button-text">Disponibilidad</span>
                </button>
            </fieldset>
        </form>           
    </div>
    <div class="grid-50 video">
        <iframe width="580" height="250" src="//www.youtube-nocookie.com/embed/kPDnw3_1GOI?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
    </div>
</div>
